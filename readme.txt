...
* displays the mobile.de vehicle stock of the dealer in posts or on pages
* easy switchable layout 
* customize css in admin panel 
...
1. Admin section of ITS Mobile Lite
2. Plugin in Frontend, use it in posts or on pages
